...
public class OpenNlpSenToken {
    public static void main(String[] args) {
        ...
        try {
            openNlp.useOpenNlp("My name is Rushdi Shams. You can use Dr. before my name as I have a Ph.D. "
                            + "but I am a bit shy to use it.",
                    "model/opennlp/opennlp-en-ud-ewt-sentence-1.0-1.9.3.bin",
                    "sentence");
            openNlp.useOpenNlp("\"Let's get this vis-a-vis\", he said, \"these boys' marks are really that well?\"",
                    "model/opennlp/opennlp-en-ud-ewt-tokens-1.0-1.9.3.bin",
                    "word");
        } catch (IOException e) {
        }
    }
