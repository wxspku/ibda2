package net.ibda.dataanalysis.weka;
...
public class WekaTrainTest {
	...
	public static void main(String[] args) throws Exception{
		...
		test.loadModel("out/weka//nb.model");
		test.loadDatasets("dataset/data/iris.arff", "dataset/data/iris-test.arff");
		test.classify();
		test.writeArff("out/weka/out.arff");
	}
}
