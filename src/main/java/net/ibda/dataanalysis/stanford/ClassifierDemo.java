...
public class ClassifierDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ColumnDataClassifier cdc = new ColumnDataClassifier(where + "dataset/Stanford/cheese2007.prop");
    cdc.trainClassifier(where + "dataset/Stanford/cheeseDisease.train");

    System.out.println();
    System.out.println("Testing predictions of ColumnDataClassifier");
    for (String line : ObjectBank.getLineIterator(where + "dataset/Stanford/cheeseDisease.test", "utf-8")) {
    ...
    Pair<Double, Double> performance = cdc.testClassifier(where + "dataset/Stanford/cheeseDisease.test");
  ...
  private static void demonstrateSerialization()
    ...
    Classifier<String,String> cl =
            cdc.makeClassifier(cdc.readTrainingExamples(where + "dataset/Stanford/cheeseDisease.train"));
    ...
    ois.close();
    ColumnDataClassifier cdc2 = new ColumnDataClassifier(where + "dataset/Stanford/cheese2007.prop");
