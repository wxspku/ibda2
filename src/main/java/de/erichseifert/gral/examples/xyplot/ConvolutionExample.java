...
public class ConvolutionExample extends ExamplePanel {
	...
	public ConvolutionExample() {
		...
		DataSource dataLowpass = new Convolution(data, kernelLowpass, Filter.Mode.REPEAT, 1);
		...
		DataSource dataHighpass = new Convolution(data, kernelHighpass, Filter.Mode.REPEAT, 1);
		...
		DataSource dataMovingAverage = new Convolution(data, kernelMovingAverage, Filter.Mode.OMIT, 1);
		...
		DataSource dataMovingMedian = new Median(data, kernelMovingMedianSize, kernelMovingMedianSize - 1, Filter.Mode.OMIT, 1);
